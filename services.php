...
<section class="content">
    ...
    <section class="main-container" id="individual">
        ...
        <div class="information-two">
            ...
            <p class="page-info">
            <ul class="page-info">
                <li>Private, one-on-one online sessions tailored to your needs</li>
                <li>Helpful techniques for managing your mental health</li>
                <li>A supportive space where you can speak freely</li>
            </ul>
            </p>
        </div>
    </section>
    ...
    <section class="main-container" id="couples">
        <div class="information">
            ...
            <p class="page-info">
                ...
                or conflicts, our therapy sessions help couples understand 
                each other better.
            </p>
        </div>
        ...
        <div class="information-two">
            ...
            <p class="page-info">
            <ul class="page-info">
                <li>Guide to improve communication and resolve conflicts</li>
                <li>Strategies to rebuild trust and connection</li>
                <li>Guidance on how to express feelings and find solutions together</li>
            </ul>
            </p>
        </div>
    </section>
    ...
    <section class="main-container">
        ...
        <div class="information-two">
            ...
            <p class="page-info">
            <ul class="page-info">
                <li>Tools to manage conflict and improve relationships</li>
                <li>Safe space for open discussions and healing</li>
                <li>Strategies for fostering understanding and growth</li>
            </ul>
            </p>
        </div>
    </section>
    ...
    <section class="main-container" id="trauma">
        ...
        <div class="information-two">
            ...
            <p class="page-info">
            <ul class="page-info">
                <li>Therapeutic approaches for PTSD and emotional trauma</li>
                <li>Guidance through grief, loss, and bereavement</li>
                <li>Techniques to help process emotions and heal</li>
            </ul>
            </p>
        </div>
    </section>
